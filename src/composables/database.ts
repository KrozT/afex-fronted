...
export function useDatabase() {
  ...
  const firebaseConfig = {
    apiKey: import.meta.env.YAULT_FIREBASE_API_KEY,
    authDomain: import.meta.env.YAULT_FIREBASE_AUTH_DOMAIN,
    projectId: import.meta.env.YAULT_FIREBASE_PROJECT_ID,
    storageBucket: import.meta.env.YAULT_FIREBASE_STORAGE_BUCKET,
    messagingSenderId: import.meta.env.YAULT_FIREBASE_MESSAGING_SENDER_ID,
    appId: import.meta.env.YAULT_FIREBASE_APP_ID,
    measurementId: import.meta.env.YAULT_FIREBASE_MEASUREMENT_ID,
  };
